...
from p_tuning_config import PPromptEncoderConfig, PromptEncoderReparameterizationType
    ...
    def __init__(self, config):
        ...
        if not config.inference_mode:
            if self.encoder_type == PromptEncoderReparameterizationType.LSTM:
                ...
                # TODO
                encoder_num_layers_default = PPromptEncoderConfig.encoder_num_layers
