...
from .utils_other import _prepare_prompt_learning_config

# TODO CUSTOM
from .config import PeftConfig
from .peft_model import (
    PeftModel,
    PeftModelForCausalLM,  # TODO
    PeftModelForFeatureExtraction,
    PeftModelForQuestionAnswering,
    PeftModelForSeq2SeqLM,  # TODO
...
MODEL_TYPE_TO_PEFT_MODEL_MAPPING: dict[str, type[PeftModel]] = {
    ...
    "SEQ_2_SEQ_LM": PeftModelForSeq2SeqLM,  # TODO for t5
    "CAUSAL_LM": PeftModelForCausalLM,  # TODO for llama
...
from .pplug import PPrefixTuningConfig, PPromptEncoderConfig, PPromptTuningConfig
...
PEFT_TYPE_TO_CONFIG_MAPPING: dict[str, type[PeftConfig]] = {
    ...
    # TODO
    "PLORA": PLoraConfig,
    "PPROMPT_TUNING": PPromptTuningConfig,
    "PPREFIX_TUNING": PPrefixTuningConfig,
    "PP_TUNING": PPromptEncoderConfig,
}
...
def get_peft_model(
    ...
    # TODO <class 'LaMP.PLoRA.ppeft.peft_model.PeftModelForCausalLM'>
