...
# TODO
from peft.import_utils import is_auto_gptq_available, is_torch_tpu_available
...
def _prepare_prompt_learning_config(peft_config, model_config):
    ...
    if peft_config.peft_type in ["PREFIX_TUNING", "PPREFIX_TUNING"] and "num_key_value_heads" in model_config:
