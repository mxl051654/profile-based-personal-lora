...
def get_peft_model_state_dict(
    ...
    # TODO TUNER SPECIFIC CODE  add plora
    if config.peft_type in (PeftType.LORA, PeftType.ADALORA, PeftType.PLORA):
    ...
    # TODO cus plora合并到 lora
    # elif config.peft_type == PeftType.PLORA:
...
# TODO for peftmodel.from_pretrain
